				...
				<div style="margin: 0px; background-color: white; margin: 0 10px;">
					<blockquote class="layui-elem-quote">
						...
						<div class="layui-form-item">
							<label class="layui-form-label">${study_title}</label>
						</div>
						<div class="layui-form-item">
							<div class="layui-inline">
								<label class="layui-form-label">${study_type}</label>
							</div>
						</div>
						<div class="layui-form-item">
							<div class="layui-inline">
								<label class="layui-form-label">${study_date}</label>
							</div>
						</div>
						</center>
					</blockquote>
					<div class="layui-form-item">
						<div class="layui-inline">
							...
							<div class="layui-input-block">${study_content}</div>
						</div>
					</div>
					<div class="cxbottom">
						<center>
