			...
			<ul class="list-unstyled">
				...
				<li class="active"><a href="#branchManager"
					...
					<ul id="branchManager" class="collapse list-unstyled ">
						<li class="active"><a href="/mis/admin/addMemberPage">添加支部成员</a></li>
				...
				<div style="margin: 0px; background-color: white; margin: 0 10px;">
								...
								<div class="tableWrap">
									<table width="100%" class="table table-hover table-bordered"
										...
										<tr>
											...
											<th>学号：</th>
											<td><input type="text" placeholder="模糊查询，学号的一部分即可"
									...
									<tr style="height: auto;">
										...
										<td>
											<button class="btn btn-warning btn-sm"
												onclick="updateMemberModal(this)" data-toggle="modal">分配支部</button>
										</td>
									</tr>
								</c:forEach>
							</tbody>
					...
					<center>
						<li>共<i class="blue">${pageInfo.total}</i>条记录，当前显示第<i
							...
							href="${pageContext.request.contextPath}/admin/addMemberPageFinder?currentPage=1"><button
									class="layui-btn layui-btn-normal  layui-btn-sm">首页</button></a> 
									</c:if> <c:if
								test="${pageInfo.hasPreviousPage && pageInfo.pageNum!=1}">
								<a
									href="${pageContext.request.contextPath}/admin/addMemberPageFinder?currentPage=${pageInfo.pageNum-1}"><button
							...
							href="${pageContext.request.contextPath&& pageInfo.pageNum!=0}/admin/addMemberPageFinder?currentPage=${pageInfo.pages}"><button>
									末页</button></a></c:if> 
						</li>
					</center>
					<div class="cxbottom">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h4 class="modal-title" id="myModalLabel">添加成员至新支部</h4>
				...
				<form name="updateMemberForm" id="updateMemberForm"
					...
					<div class="modal-body">
						学&ensp;&ensp;&ensp;&ensp;号：&ensp;&ensp;<input
							...
							name="student_num_check" readonly>
					</div>
					<div class="modal-body">
						姓&ensp;&ensp;&ensp;&ensp;名： &ensp;&ensp;<input
							id="student_name_check" style="border: none;" type="text"
							name="student_name_check" readonly>
					</div>
					<div class="modal-body">
					...
					<div class="modal-body">
						分配支部： <select name="branch_name" id="branch_name">
