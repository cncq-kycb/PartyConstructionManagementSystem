			...
			<ul class="list-unstyled">
				...
				<li class="active"><a href="#memberManager"
					...
					<ul id="memberManager" class="collapse list-unstyled ">
						<li class="active"><a href="manageMemberPage">成员信息管理</a></li>
						<li><a href="updateStatusPage">成员级别管理</a></li>
					</ul></li>
				...
				<div style="margin: 0px; background-color: white; margin: 0 10px;">
					<blockquote class="layui-elem-quote">
						...
						<div class="panel-body" style="padding-bottom: 0px;">
							<form class="form-horizontal" name="inputForm "
								action="manageMemberPageFinder" onsubmit="return validateForm()"
								method="post">
					...
					<center>
						<li>共<i class="blue">${pageInfo.total}</i>条记录，当前显示第<i
							...
							<a
							href="${pageContext.request.contextPath}/manageMemberPage?currentPage=1"><button
									class="layui-btn layui-btn-normal  layui-btn-sm">首页</button></a> <c:if
								test="${pageInfo.hasPreviousPage }">
								<a
									href="${pageContext.request.contextPath}/manageMemberPage?currentPage=${pageInfo.pageNum-1}"><button
							...
							href="${pageContext.request.contextPath}/manageMemberPage?currentPage=${pageInfo.pages}"><button>
									末页</button></a>
						</li>
					</center>
					<div class="cxbottom">
