	...
	<div class="page">
		...
		<div class="page-content d-flex align-items-stretch">
			<div class="content-inner">
				<blockquote class="layui-elem-quote">
					<center>
						...
						<div class="layui-form-item">
							<label class="layui-form-label"><h1>${study.study_title}</h1></label>
						</div>
						<div class="layui-form-item">
							<div class="layui-inline">
								<label class="layui-form-label">所在栏目：${study.study_status}&ensp;&ensp;&ensp;&ensp;上线时间：${study.study_date}</label>
							</div>
						</div>
					</center>
				</blockquote>
				<div class="layui-form-item">
					<div class="layui-inline">
						<div style="margin-left: 150px;" class="layui-input-block">${study.study_content}</div>
					</div>
				</div>
				<div class="cxbottom">
					<center>
