...
<div>&ensp;&ensp;</div>
	<form class="form-horizontal" name="inputForm"
								...
								<div class="line"></div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">&ensp;&ensp;原密码：</label>
									
										<input type="password" name="psw_old" id="psw_old"
											placeholder="请输入原密码" class="form-control">
								
								</div>
								<div class="line"></div>
								<div class="form-group row">
									<label class="col-sm-3 form-control-label">&ensp;&ensp;新密码：</label>
									
										<input type="text" name="psw_new" id="psw_new"
								...
								<div class="line"></div>
									...
									<label class="col-sm-3 form-control-label">&ensp;&ensp;重复新密码：</label>
										...
										<input type="text"name="psw_re" id="psw_re"
