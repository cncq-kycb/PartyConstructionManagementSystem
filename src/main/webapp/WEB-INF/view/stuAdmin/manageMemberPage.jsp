					...
					<blockquote class="layui-elem-quote">
						...
						<div class="panel-body" style="padding-bottom: 0px;">
							<form class="form-horizontal" name="inputForm "
								action="/mis/stuAdmin/manageMemberPageFinder" method="post">
								...
								<div class="tableWrap">
									<table width="100%" class="table table-hover table-bordered"
										...
										<tr>
											...
											<th>所在支部：</th>
											<td><input type="text" value="${my_branch_name}"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form name="updateMemberForm" id="updateMemberForm"
					action="/mis/stuAdmin/updateMember" onsubmit="return anotherValidateForm()"
